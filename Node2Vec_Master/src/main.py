...
def parse_args():
	...
	parser.add_argument('--input', nargs='?', default='crimeedgelist.txt',
	                    help='Input graph path')

	parser.add_argument('--output', nargs='?', default='crime.txt',
...
def learn_embeddings(walks):
	...
	#model = Word2Vec(walks, size=args.dimensions, window=args.window_size, min_count=0, sg=1, workers=args.workers, epochs=args.iter)
